...
```{r}
log_data = TOT[, c("Indeb_tot_pond", "ETA", "SEX", "STUDIO", "NCOMP", "NPERL", "W_pond", "ACOM4C", "Y_FAM_pond")]
```
...
```
```{r}
model_tot = lm(formula = Indeb_tot_pond ~ ETA + NCOMP + NPERL + W_pond + ACOM4C + Y_FAM_pond, data = log_data)
summary(model_tot)
```
```{r}
